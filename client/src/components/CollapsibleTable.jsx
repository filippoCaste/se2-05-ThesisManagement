...
import { Box, Collapse, Button, IconButton, Table, TableBody, TableCell, TableHead,TableRow, Typography} from '@mui/material';
...
function Row(props) {
  ...
  return (
    <React.Fragment>
      <TableRow sx={{ '& > *': { borderBottom: 'unset', backgroundColor: isEvenRow ? '#f5f5f5' : '#ffffff' } }}>
        ...
        <TableCell style={{width: '30%'}} component="th" scope="row">{row.p.title}</TableCell>
      ...
      <TableRow>
        <TableCell style={{ paddingBottom: 0, paddingTop: 0, backgroundColor: isEvenRow ? '#f5f5f5' : '#ffffff' }} colSpan={6}>
  ...
  return (
      <Table aria-label="collapsible table">
        <TableHead>
          <TableRow>
            <TableCell style={{width: '5%'}}/>
            <TableCell style={{width: '30%'}}><b>Title</b></TableCell>
